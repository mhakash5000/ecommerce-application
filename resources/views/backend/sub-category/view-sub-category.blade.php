        ...
        <div class="card-body ">
            <div class="row">
                <div class="col-md-12  d-flex justify-content-between align-items-center">
                    <h5 class="display-5">Sub Category List</h5>
                  <a href="{{route('sub.categories.create')}}" class="btn btn-warning text-dark"><i class="fa fa-plus-circle"></i>Create Sub Category</a>
                </div>
            </div>
        </div>
    </div>
